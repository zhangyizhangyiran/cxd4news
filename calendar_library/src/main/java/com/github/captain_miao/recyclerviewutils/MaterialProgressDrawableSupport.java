...
public class MaterialProgressDrawableSupport extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        private int mCurrentColor;/** Modify By Gele **/
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            //mPaint.setColor(mColors[mColorIndex]);/** Modify By Gele **/
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (mShowArrow) {
                ...
                mArrow.close();
                // draw a triangle
                //mArrowPaint.setColor(mColors[mColorIndex]);/** Modify By Gele **/
        ...
        public void setColors(@NonNull int[] colors) {
            ...
            setColorIndex(0);/** Modify By Gele **/
        }
