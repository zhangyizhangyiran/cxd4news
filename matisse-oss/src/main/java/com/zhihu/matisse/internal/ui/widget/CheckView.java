...
//        int defaultColor = new ResourcesCompat().getColor(
//                getResources(), R.color.zhihu_item_checkCircle_borderColor,
//                getContext().getTheme());

        int defaultColor =getResources().getColor(R.color.zhihu_item_checkCircle_borderColor);
...
//                R.drawable.ic_check_white_18dp, context.getTheme());
        ...
        mCheckDrawable =getResources().getDrawable(R.drawable.ic_check_white_18dp);
    }
...
//                    getContext().getTheme());
            int defaultColor=getResources().getColor(R.color.zhihu_item_checkCircle_backgroundColor);
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
