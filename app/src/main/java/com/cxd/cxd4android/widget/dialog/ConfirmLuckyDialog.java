...
// * version：V1.0
// */
//public  class ConfirmLuckyDialog extends Dialog{
//
//
...
//
//
//	public ConfirmLuckyDialog(Context context) {
//		super(context);
//		this.context=context;
//		initView();
//
//	}
//	public ConfirmLuckyDialog(Context context, int theme){
//		super(context, theme);
//		this.context = context;
//		initView();
//	}
//
//	void initView(){
//		mView=LayoutInflater.from(this.context).inflate(R.layout.widget_layout__confirmlucky_dialog, null);
//
