package com.cxd.cxd4android.widget.rollout.activity;
...
import com.cxd.cxd4android.widget.rollout.tools.RCommonUtil;
import com.cxd.cxd4android.widget.rollout.tools.RGlideUtil;
import com.cxd.cxd4android.widget.rollout.view.RolloutViewPager;
...
public class RolloutPreviewActivity extends RolloutBaseActivity implements ViewPager.OnPageChangeListener {
    ...
    public void InData() {
        ...
        if (type == 1) {
            ...
            moveheight = (Width - RCommonUtil.dip2px(this, 70) - RCommonUtil.dip2px(this, 2)) / 3;
        }
    }
...
//            to_y = move_index * moveheight;
    ...
    class SamplePagerAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            Glide.with(RolloutPreviewActivity.this).load(path).error(R.mipmap.ic_banner_bg).into(photoView);
