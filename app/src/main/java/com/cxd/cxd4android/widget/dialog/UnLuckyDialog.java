...
//
///**
// * ClassName:积分抽奖 - 未中奖弹框
// * Description：
// * Author：XiaoFa
// * Date：2016/5/4 16:00
// * version：V1.0
// */
//public  class UnLuckyDialog extends Dialog{
//
//
...
//
//
//	public UnLuckyDialog(Context context) {
//		super(context);
//		this.context=context;
//		initView();
//
//	}
//	public UnLuckyDialog(Context context, int theme){
//		super(context, theme);
//		this.context = context;
//		initView();
//	}
//
//	void initView(){
//		mView=LayoutInflater.from(this.context).inflate(R.layout.widget_layout__unlucky_dialog, null);
//
