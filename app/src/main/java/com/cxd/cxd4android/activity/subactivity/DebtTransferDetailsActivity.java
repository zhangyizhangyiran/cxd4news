...
// */
//public class DebtTransferDetailsActivity extends BaseActivity implements LoadingView {
//    /**
//     * 购买页面信息
//     */
...
//     * 转让标名称
//     **/
//    @Bind(R.id.debt_details_housing_mortgage)
//    TextView debt_details_housing_mortgage;
//    /**
//     * 转让年化率
//     **/
//    @Bind(R.id.debt_details_rate_num)
//    TextView debt_details_rate_num;
//
//    /**
//     * 转让项目详情
//     **/
//    @Bind(R.id.debt_details_prouduct_details)
//     TextView debt_details_prouduct_details;
//    /**
//     * 转让项目风控
//     **/
//    @Bind(R.id.debt_details_prouduct_risk)
//     TextView debt_details_prouduct_risk;
//    /**
//     * 转让投资记录
//     **/
//    @Bind(R.id.debt_details_inves_recod)
//     TextView debt_details_inves_recod;
//    /**
//     * 转让还款计划
//     **/
//    @Bind(R.id.debt_details_repayment_plan)
//     TextView debt_details_repayment_plan;
//    /**
//     * 转让 转让价格
//     **/
...
//     * 购买马上赚钱
//     **/
//    @Bind(R.id.debt_details_submit_makemoney)
//    Button debt_details_submit_makemoney;
//
//
...
//        setContentView(R.layout.activity_layout_debttransfer_details);
//        EventBus.getDefault().register(this);
//        ButterKnife.bind(this);
//        loanPresenter = new BuyProductLoanPresenter(DebtTransferDetailsActivity.this);
//
...
//        debt_details_housing_mortgage.setText(InvesListModel.name);
//        debt_details_rate_num.setText(InvesListModel.rate);
...
//        }
//        debt_details_account_balance.setText("\t" + userModel.getbalanceAvaliable());
//
//    }
//
//    @OnClick({R.id.Btn_left, R.id.debt_details_prouduct_details, R.id.debt_details_prouduct_risk, R.id.debt_details_inves_recod, R.id.debt_details_account_rechange, R.id.debt_details_submit_makemoney})
...
//                break;
//            case R.id.debt_details_prouduct_details://项目详情
//                BuyProductDetailsFragment();
//                break;
//            case R.id.debt_details_prouduct_risk://项目风控
//                BuyProductRiskFragment();
//                break;
//            case R.id.debt_details_inves_recod://投资记录
//                BuyProductRecodFragment();
//                break;
//            case R.id.debt_details_repayment_plan://还款计划
//                BuyProductRecodFragment();
//                break;
//            case R.id.debt_details_account_rechange://充值
//
//                if (userModel.LOGIN_STATE_ONLINE.equals(userModel.getLOGIN_STATE())) {//已登录
////                    if (("绑卡成功").equals(userModel.getBankCardStatus())) {//已绑定银行卡!Q.isEmpty(userModel.getBindCard())
//
//                    //验证是否实名
...
//                            Intent intent = new Intent(DebtTransferDetailsActivity.this, CheckoutGestureLockActivity.class);
//                            intent.putExtra("KEY", "BuyProductActivityRechange");
...
//                }
//                break;
//            case R.id.debt_details_submit_makemoney://立即购买
//
//                if (userModel.LOGIN_STATE_ONLINE.equals(userModel.getLOGIN_STATE())) {//已登录
...
//                                initDataMakemoney();
//                            } else if (("ON").equals(userModel.getGestrueSwitch())) {
//                                Intent intents = new Intent(DebtTransferDetailsActivity.this, CheckoutGestureLockActivity.class);
...
//                Intent intent = new Intent(DebtTransferDetailsActivity.this, MainActivity.class);
//                startActivity(intent);
//                try {
//                    EventBus.getDefault().post(new ILoginCallBack(4));
...
//
//        Intent it = new Intent(DebtTransferDetailsActivity.this, MeRechargeActivity.class);
//        startActivity(it);
//    }
//
//    /**
...
//
//        Intent intent = new Intent(DebtTransferDetailsActivity.this, BuyProducRecodActivity.class);
...
//
//        Intent intent = new Intent(DebtTransferDetailsActivity.this, BuyProducRiskActivity.class);
...
//
//        Intent intent = new Intent(DebtTransferDetailsActivity.this, BuyProducDetailsActivity.class);
//        intent.putExtra("InvesListModel", InvesListModel);
//        startActivity(intent);
//    }
//
...
//
//        startActivity(new Intent(DebtTransferDetailsActivity.this, YeePayActivity.class).putExtra("YeePayModel", payModel));
//    }
//
//
...
//         */
//        StatService.onPageStart(DebtTransferDetailsActivity.this, "投资页面");//(this);
//    }
//
//    public void onPause() {
//        super.onPause();
...
//         */
//        StatService.onPageEnd(DebtTransferDetailsActivity.this, "投资页面");//(this);
//    }
//
//    @Override
