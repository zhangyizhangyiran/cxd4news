...
import com.cxd.cxd4android.adapter.MainInvesSimpleAdapter;
 ...
 */
public class MainInvestmentFragment extends BaseFragment implements LoadingView {
     ...
     * 投资列表适配器
     **/
    private MainInvesSimpleAdapter mAdapter;
    /**
     * 数据类型
     **/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView == null) {
            contentView = inflater.inflate(R.layout.fragment_layout_main_invesment, container, false);
            return contentView;
        }
    ...
    private void setAdapter() {
        mAdapter = new MainInvesSimpleAdapter(getActivity());
...
//                }
    ...
    public void on2OptionPicker(View view) {
        ...
        picker.setOnWheelListener(new WheelPicker.OnWheelListener<int[]>() {
            ...
            public void onSubmit(int[] result) {
                ...
                String invest_screen = option1.get(result[0]) + "---" + option2.get(result[0]).get(result[1]);
                StatService.onEvent(getActivity(), BaiDustatistic.invest_screen, invest_screen, 1);//事件统计
            }
        });
        picker.showAtBottom();
    }
    ...
    public void onResume() {
         ...
         */
        StatService.onPageStart(getActivity(), "投资页面");//(this);
    }
    ...
    public void onPause() {
         ...
         */
        StatService.onPageEnd(getActivity(), "投资页面");//(this);
    }
