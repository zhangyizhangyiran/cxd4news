 ...
 * version：V1.0
 */
public class MeMyPwsLoginModifyFragmentPresenter extends MicroBasePresenter<LoadingView> {

    public MeMyPwsLoginModifyFragmentPresenter(LoadingView view) {
        attachView(view);
    }
    ...
    public void loadData(String strn) {
        ...
        addSubscription(apiStores.getUpdatePsw(strn),
