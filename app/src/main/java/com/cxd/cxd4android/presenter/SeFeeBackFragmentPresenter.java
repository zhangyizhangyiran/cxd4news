 ...
 * version：V1.0
 */
public class SeFeeBackFragmentPresenter extends MicroBasePresenter<LoadingView> {

    public SeFeeBackFragmentPresenter(LoadingView view) {
        attachView(view);
    }
    ...
    public void loadData(String strn) {
        ...
        addSubscription(apiStores.getFeedback(strn),
