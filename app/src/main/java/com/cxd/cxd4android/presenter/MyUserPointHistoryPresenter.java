 ...
 * @Date：2016/7/6 16:46
 */
public class MyUserPointHistoryPresenter extends MicroBasePresenter<LoadingView> {

    public MyUserPointHistoryPresenter(LoadingView view) {
        attachView(view);
    }
    ...
    public void loadData(String strn) {
        ...
        addSubscription(apiStores.getUserPointHistory(strn),
