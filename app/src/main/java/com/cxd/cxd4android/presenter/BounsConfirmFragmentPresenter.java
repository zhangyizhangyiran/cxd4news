 ...
 * version：V1.0
 */
public class BounsConfirmFragmentPresenter extends MicroBasePresenter<LoadingView> {

    public BounsConfirmFragmentPresenter(LoadingView view) {
        attachView(view);
    }
    ...
    public void loadData(String strn) {
        ...
        addSubscription(apiStores.getSaveDHGift(strn),
