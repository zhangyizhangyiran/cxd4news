 ...
 * version：V1.0
 */
public class SeMainFragmentPresenter extends MicroBasePresenter<LoadingView> {

    public SeMainFragmentPresenter(LoadingView view) {
        attachView(view);
    }
    ...
    public void loadData(String strn) {
        ...
        addSubscription(apiStores.getMoneyStatic(strn),
                new SubscriberCallBack<ServiceBaseModel>(new ApiCallback<ServiceBaseModel>() {
                    @Override
                    public void onSuccess(ServiceBaseModel model) {
